...
class DialogTemplate {
    ...
    .sew_scrollbar::-webkit-scrollbar-track {
        border-radius: 10px;
        background-color: rgba(226, 228, 242, 1);
    }

    .sew_scrollbar::-webkit-scrollbar-thumb {
        border-radius: 10px;
        background-color: rgba(173, 176, 208, 1);
    }
        ...
        <div class="sew_dialog" data-dialog>
            ...
            <div class="sew_dialog-body">
                <div class="sew_input-group">
                    <div class="sew_label">${chrome.i18n.getMessage('subject')}</div>
                ...
                <div class="sew_input-group">
                    ...
                    <textarea class="sew_textarea sew_scrollbar" placeholder="${chrome.i18n.getMessage('description_placeholder')}" data-field="description"></textarea>
                </div>
                <div class="sew_input-group sew_group-row">
                    <div class="sew_row-cell">
                        <div class="sew_label">${chrome.i18n.getMessage('level')}</div>
                        <div class="sew_select" data-level_select>
                ...
                <div class="sew_input-group sew_group-row">
                    <div class="sew_row-cell">
                        <div class="sew_label">${chrome.i18n.getMessage('essay_style')}</div>
                        <div class="sew_select" data-essay_style_select>
                    ...
                    <div class="sew_row-cell">
                        <div class="sew_label">${chrome.i18n.getMessage('ref_style')}</div>
                        <div class="sew_select" data-ref_style_select>
